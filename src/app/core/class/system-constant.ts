...
export const SystemConstant = Object.freeze({
  ...
  // 建筑物采暖通风及空调调查表
  BUILDING_AERATION_DETAIL: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordAuxiliaryHealth/detail',
  BUILDING_AERATION_ADD: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordAuxiliaryHealth/add',
  BUILDING_AERATION_EDIT: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordAuxiliaryHealth/update',
  ...
  // 职业病防治经费投入情况调查表
  RECORD_HEALTH_CARE_DETAIL: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordFunds/detail',
  RECORD_HEALTH_CARE_ADD: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordFunds/add',
  RECORD_HEALTH_CARE_EDIT: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordFunds/update',

  RECORD_AUXILIARY_HEALTH_ADD: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordFunds/detail',
  RECORD_AUXILIARY_HEALTH_EDIT: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordFunds/detail',
  RECORD_AUXILIARY_HEALTH_DETAIL: INTERFACE_ADDRESS + SYSTEM_GATEWAY + INTERFACE_VERSION + '/recordFunds/detail'
